...
const PostEdit = () => {
    ...
    const handlesubmit=(e)=>{
      e.preventDefault();
      const empdata={id,name,email,comments,phone,active};
                            ...
                            <div className="row">
                                ...
                                <div className="col-lg-12">
                                    <div className="form-group">
                                        ...
                                        <input value={comments} onChange={e=>commentschange(e.target.value)} className="form-control" required></input>
                                    </div>
                                </div>
                                ...
                                <div className="col-lg-12">
                                    ...
                                    <input checked={active} onChange={e=>activechange(e.target.checked)} type="checkbox" className="form-check-input" required></input>
